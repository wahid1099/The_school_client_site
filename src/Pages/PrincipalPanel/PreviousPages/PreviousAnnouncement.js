...
const PreviousAnnouncement = () => {
  ...
  const EditHandler = (id) => {
    fetch(
      `https://the-school-network-server.vercel.app/GetEditAnnouncement/${id}`
    )
      .then((res) => res.json())
      .then((data) => {
        setEditnotice(data);
        ...
        {previousAnnouncement?.map((announcement) => (
          <div className="bg-white shadow-lg rounded-lg mt-5 p-5">
            ...
            <div className="button_div ml-4">
              ...
              <button
                onClick={() => EditHandler(announcement._id)}
                className="edit_btn"
              >
                EDIT
              </button>
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="principal_notice_publish_form mx-auto mt-8 shadow-lg shadow-indigo-500/50">
                        ...
                        />
                        <button
                          onClick={SubmitEditAnnouncement}
