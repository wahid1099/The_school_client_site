...
const RegisterTeacher = () => {
    ...
    RegisterUser(regdata.email, regdata.password)
      .then((userCredential) => {
        ...
        SaveTeacher(
          ...
          regdata.teachername,
          regdata.role,
          regdata.teacherclass,
          regdata.teachersection,
          regdata.teachernid,
          regdata.teacherphone,
          regdata.teacheraddress
        );
  ...
  const SaveTeacher = (
    ...
    fetch("https://the-school-network-server.vercel.app/addUser", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="mt-4" style={{ width: "100%" }}>
      ...
      <form
        ...
        className="principal_register_teacher mt-8"
      >
        ...
        <button
          type="submit"
          className="publish_btn shadow-lg shadow-indigo-500/50"
        >
          ADD TEACHER
        </button>
      </form>
