...
export const GetExtraCareRequest = createAsyncThunk(
  ...
  async (teacherclass) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/requestCare?teacherclass=${teacherclass}`
    ).then((res) => res.json());
    return response;
  }
);
...
export const noticePublishFromTeacher = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/PublishNotice",
      {
        method: "POST",
        headers: {
...
export const getTeacherInfo = createAsyncThunk(
  ...
  async (email) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/TeacherProfile?email=${email}`
    ).then((res) => res.json());
    return response;
  }
);
...
export const updateTeacherDP = createAsyncThunk(
  ...
  async (data) => {
    ...
    const response = await fetch(
      `https://the-school-network-server.vercel.app/UpdateTeacherDP?email=${data.email}`,
      {
        method: "PUT",
        body: data.fd,
      }
...
export const addTeacherInfo = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/AddTeacherInfo?email=${data.email}`,
      {
        method: "PUT",
        headers: {
          "content-type": "application/json",
...
export const PublishResult = createAsyncThunk(
  ...
  async (data) => {
    ...
    const response = await fetch(
      "https://the-school-network-server.vercel.app/PublishResult",
      {
        method: "POST",
        headers: {
          "content-type": "application/json",
...
export const GetIndividualCare = createAsyncThunk(
  ...
  async (id) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/GetIndividualCare/${id}`
    )
      .then((res) => res.json())
      .catch((error) => {
        Swal.fire("!", "Error!", "error");
...
export const ChangeRequestHandler = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/ChangeRequestHandler?status=${data.status}&&id=${data.id}`
    )
      .then((res) => res.json())
      .catch((error) => {
        Swal.fire("!", "Error!", "error");
...
export const assignmentPublish = createAsyncThunk(
  ...
  async (data) => {
    console.log(data);
    const response = await fetch(
      "https://the-school-network-server.vercel.app/assignmentPublish",
      {
        method: "POST",
        headers: {
          "content-type": "application/json",
...
export const GetingPreviosuAssignment = createAsyncThunk(
  ...
  async () => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/GetingPreviosuAssignment"
    ).then((res) => res.json());
    return response;
  }
);
...
export const PublishImageAssing = createAsyncThunk(
  ...
  async (fd) => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/PublishImageAssing",
      {
        method: "POST",
        body: fd,
      }
...
export const DeleteAssignment = createAsyncThunk(
  ...
  async (id) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/DeleteAssignment/${id}`,
      {
        method: "DELETE",
      }
    );
...
export const AddBooks = createAsyncThunk("Teacher/AddBooks", async (data) => {
  const response = await fetch(
    "https://the-school-network-server.vercel.app/AddBook",
    {
      method: "POST",
      body: data,
    }
...
export const GetAllBooks = createAsyncThunk("Teacher/GetAllBooks", async () => {
  const response = await fetch(
    "https://the-school-network-server.vercel.app/GetAllBooks"
  )
    .then((res) => res.json())
    .catch((error) => {
      Swal.fire("!", "Error!", "error");
...
export const SubmitEditedBook = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/SubmitEditedBook/${data.id}`,
      {
        method: "PUT",
        headers: {
          "content-type": "application/json",
...
export const DeleteBook = createAsyncThunk("Teacher/DeleteBook", async (id) => {
  const response = await fetch(
    `https://the-school-network-server.vercel.app/DeleteBook/${id}`,
    {
      method: "DELETE",
    }
  )
...
export const GetAllLendBooks = createAsyncThunk(
  ...
  async () => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/GetAllLendBooks"
    )
      .then((res) => res.json())
      .catch((error) => {
        Swal.fire("!", "Error!", "error");
...
export const NotifyStudents = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/NotifyStudents",
      {
        method: "POST",
...
export const teacherVideoUpload = createAsyncThunk(
  ...
  async (data) => {
    ...
    const response = await fetch(
      "https://the-school-network-server.vercel.app/videoUpload",
      {
        method: "POST",
        // headers: { "content-type": "application/json" },
        body: data,
...
export const UploadClassRoutine = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/UploadClassRoutine?class=${data.classRoutineData.class}&&section=${data.classRoutineData.section}`,
      {
        method: "POST",
        body: data.fd,
      }
...
export const UploadExamRoutine = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/UploadExamRoutine?class=${data.class}&&term=${data.term}`,
      {
        method: "POST",
        body: data.fd,
      }
...
export const GetClassRoutine = createAsyncThunk(
  ...
  async () => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/GetClassRoutine"
    ).then((res) => res.json());
    return response;
  }
);
...
export const GetExamRoutine = createAsyncThunk(
  ...
  async () => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/GetExamRoutine"
    ).then((res) => res.json());
    return response;
  }
);
...
export const AddAttendanceData = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      "https://the-school-network-server.vercel.app/AddAttendanceData",
      {
        method: "PUT",
        headers: {
          "content-type": "application/json",
...
export const DeleteClassRoutine = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/DeleteClassRoutine?id=${data}`,
      {
        method: "DELETE",
      }
    );
...
export const DeleteExamRoutine = createAsyncThunk(
  ...
  async (id) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/DeleteExamRoutine?id=${id}`,
      {
        method: "DELETE",
      }
    );
...
export const GetSubmittedAssignments = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch(
      `https://the-school-network-server.vercel.app/GetSubmittedAssignments?id=${data}`
    ).then((res) => res.json());
    return response;
  }
);
